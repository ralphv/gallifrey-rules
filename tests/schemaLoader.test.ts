...
describe('schema loader', () => {
    it('loading basic schema file', async () => {
        try {
            ...
            await schemaLoader.loadSchemaFromFile('./tests/other/sample-namespace-schema.json');
    ...
    it('loading basic schema file with missing namespace', async () => {
        const schemaLoader = new SchemaLoader();
        try {
            await schemaLoader.loadSchemaFromFile('./tests/other/empty-namespace-schema.json');
